...
import totalorderplan as tp
import executionscript as es
import plandispatcher as pd
...
class PlanLibrary:
    def __init__(self, scenario_directory_name = "", trace = True):
       # Initialize directory containing scenarios.
       # If non specified, defaults to the current working directory.
    ...
    def json2plan(self, json_plan) -> tp.TotalOrderPlan:
        # Converts a json description of a plan,
        # json_plan, to a python plan object.
        dict_plan = json.loads(json_plan)
        return self.dict2plan(dict_plan)

    def dict2plan (self, dict_plan) -> tp.TotalOrderPlan:
        # Converts a dictionary description of a plan,
    ...
    def get_plan (self, plan_name: str) -> tp.TotalOrderPlan or None:
        return  self.plan_library[plan_name]


    # Enter Execution Scenarios into Library
    ...
    def readscenario(self, relative_path_for_scenario : str) -> es.ExecutionScenario:
        ...
        # that corresponds to a json plan execution scenario description,
        # contained in file.
    ...
    def get_scenario (self, scenario_name: str) -> es.ExecutionScenario or None:
        return  self.scenario_library[scenario_name]

    # Execute Library Scenarios using the Dispatcher
