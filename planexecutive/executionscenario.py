...
class ExecutionScenario:
    # An execution scenario for plan named plan_name,
    # comprised of a total ordering of plan's actions and observations produced by each action.
    # Scenario specifies an observed initial state,
    # followed by pairs of invoked action and observed state changes.
